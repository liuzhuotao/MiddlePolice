...
# Stub victim ASes
sampled_victim_ASs = random.sample(stubASes, sampled_victim_count) 
...
for victim_AS in sampled_victim_ASs:
    ...
    ff = open('access_AS_redirect_path_to_stub_victim.py', 'a+')
    pprint.pprint(access_AS_redirect_path_to_victim, ff)
    ff.close()

    ff = open('access_AS_direct_path_to_stub_victim.py', 'a+')
    pprint.pprint(access_AS_direct_path_to_victim, ff)
    ff.close()

    '''
    if cloud == '13335':
        ff = open('stub_victim_access_AS_to_CloudFlare.py', 'a+')
    elif cloud == '16509':
        ff = open('stub_victim_access_AS_to_EC2.py', 'a+')
    else:
        ff = open('stub_victim_access_AS_to_cloud.py', 'a+')
...
if cloud == '13335':
    ff = open('stub_victim_cloudflare_hop_result.py', 'a+')
elif cloud == '16509':
    ff = open('stub_victim_EC2_hop_result.py', 'a+')
else:
    ff = open('stub_victim_hop_result.py', 'a+')
